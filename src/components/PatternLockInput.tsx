 ...
 * pontos) -- não é mais um campo de texto descrevendo direções. Cada ponto
 * já visitado mostra a ORDEM em que foi tocado (1, 2, 3...), igual ao
 * gesto real de desbloqueio, pra não ter ambiguidade de qual foi o
 * primeiro/segundo/terceiro elo.
 *
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      >
        ...
        {/* Linha "viva" do último ponto até o dedo/cursor, enquanto arrasta */}
      ...
      {!readOnly && (
        <div className="flex items-center justify-between w-full max-w-65">
          <p className="text-xs text-gray-400">
            {path.length > 0 ? `${path.length} pontos` : 'Arraste ligando os pontos'}
          </p>
          {path.length > 0 && (
