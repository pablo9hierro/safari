...
const MODELS: Record<string, { group: string; items: string[] }[]> = {
  'celular-apple': [
    ...
    { group: 'iPhone SE',  items: ['iPhone SE (2ª geração)', 'iPhone SE (3ª geração)'] },
  ...
  'ipad-apple': [
    { group: 'iPad Pro 13"', items: ['iPad Pro 13" M4', 'iPad Pro 12.9" (6ª geração M2)', 'iPad Pro 12.9" (5ª geração M1)', 'iPad Pro 12.9" (4ª geração)', 'iPad Pro 12.9" (3ª geração)'] },
    { group: 'iPad Pro 11"', items: ['iPad Pro 11" M4', 'iPad Pro 11" (4ª geração M2)', 'iPad Pro 11" (3ª geração M1)', 'iPad Pro 11" (2ª geração)', 'iPad Pro 11" (1ª geração)', 'iPad Pro 10.5"'] },
    { group: 'iPad Air', items: ['iPad Air 13" M3', 'iPad Air 11" M3', 'iPad Air 13" M2', 'iPad Air 11" M2', 'iPad Air (5ª geração M1)', 'iPad Air (4ª geração)', 'iPad Air (3ª geração)'] },
    { group: 'iPad (linha básica)', items: ['iPad (10ª geração)', 'iPad (9ª geração)', 'iPad (8ª geração)', 'iPad (7ª geração)'] },
    { group: 'iPad mini', items: ['iPad mini (7ª geração M3)', 'iPad mini (6ª geração)', 'iPad mini (5ª geração)', 'iPad mini (4ª geração)'] },
  ],
  'ipod-apple': [
